  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg">
      ...
      <CardContent>
        ...
        <div className="mt-8 p-5 rounded-3xl bg-primary/5 border border-primary/10 relative overflow-hidden">
          ...
          <div className="space-y-1.5">
            <div className="flex flex-col gap-1">
              ...
              <code className="text-xs font-black bg-background/50 border border-primary/10 px-3 py-2 rounded-xl text-foreground">
                vedantjadhav880@gmail.com
              </code>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-[10px] font-bold text-muted-foreground uppercase opacity-70">
